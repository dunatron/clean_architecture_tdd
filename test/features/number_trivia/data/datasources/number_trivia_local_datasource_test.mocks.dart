...
// in clean_architecture_tdd/test/features/number_trivia/data/datasources/number_trivia_local_datasource_test.dart.
...
import 'number_trivia_local_datasource_test.dart' as _i2;
...
/// A class which mocks [HiveBoxTest].
///
/// See the documentation for Mockito's code generation for more information.
class MockHiveBoxTest extends _i1.Mock implements _i2.HiveBoxTest {
  MockHiveBoxTest() {
  ...
  Iterable<dynamic> get values =>
      (super.noSuchMethod(Invocation.getter(#values), returnValue: <dynamic>[])
          as Iterable<dynamic>);
  @override
  String get name =>
  ...
  Iterable<dynamic> valuesBetween({dynamic startKey, dynamic endKey}) =>
      (super.noSuchMethod(
          ...
          returnValue: <dynamic>[]) as Iterable<dynamic>);
  @override
  ...
  _i3.Stream<_i4.BoxEvent> watch({dynamic key}) => (super.noSuchMethod(
      ...
      returnValue: Stream<_i4.BoxEvent>.empty()) as _i3.Stream<_i4.BoxEvent>);
  @override
  bool containsKey(dynamic key) =>
      (super.noSuchMethod(Invocation.method(#containsKey, [key]),
          returnValue: false) as bool);
  @override
  _i3.Future<void> put(dynamic key, dynamic value) =>
      (super.noSuchMethod(Invocation.method(#put, [key, value]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i3.Future<void>);
  @override
  _i3.Future<void> putAt(int? index, dynamic value) =>
      (super.noSuchMethod(Invocation.method(#putAt, [index, value]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i3.Future<void>);
  @override
  _i3.Future<void> putAll(Map<dynamic, dynamic>? entries) =>
      (super.noSuchMethod(Invocation.method(#putAll, [entries]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i3.Future<void>);
  @override
  _i3.Future<int> add(dynamic value) =>
      (super.noSuchMethod(Invocation.method(#add, [value]),
          returnValue: Future<int>.value(0)) as _i3.Future<int>);
  @override
  _i3.Future<Iterable<int>> addAll(Iterable<dynamic>? values) =>
